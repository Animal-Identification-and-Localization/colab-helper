...
OUTPUT_DIR="/content/training/results"

echo "GENERATING label file..."
echo "0 Cat" >> "${OUTPUT_DIR}/labels.txt"
echo "1 Person" >> "${OUTPUT_DIR}/labels.txt"
echo "2 Squirrel" >> "${OUTPUT_DIR}/labels.txt"
...
python /content/models/research/object_detection/export_tflite_ssd_graph.py \
  ...
  --trained_checkpoint_prefix="/content/training/models/model.ckpt-${ckpt_number}" \
